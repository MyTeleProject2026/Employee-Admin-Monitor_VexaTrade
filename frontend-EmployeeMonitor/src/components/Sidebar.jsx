          ...
          {navItems.map((item) => (
            <NavLink
              ...
              className={({ isActive }) => {
                ...
                return `flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition ${active ? 'bg-cyan-500/20 text-cyan-400' : 'text-slate-300 hover:bg-white/5'}`;
              }}
            >
