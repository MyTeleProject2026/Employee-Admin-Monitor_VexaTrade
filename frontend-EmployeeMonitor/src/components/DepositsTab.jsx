        ...
        <div key={dep.id} className="rounded-xl border border-white/10 bg-[#0a0e1a] p-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <span className="text-sm font-semibold text-white">{typeof dep.coin === 'string' ? dep.coin : 'USDT'}</span>
          ...
          <div className="grid grid-cols-2 gap-1 text-xs text-slate-400">
            <div className="col-span-2 truncate">
              <span className="text-slate-500">Address:</span> {typeof dep.address === 'string' ? dep.address : '—'}
            </div>
